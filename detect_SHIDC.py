    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                cellResult['imageHeight'] = 1228
                cellResult['imageWidth'] = 1228
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if opt.save_label_json:
                        ...
                        cellShape['label'] = str(int(label)+1)
                        cellShape['points'] = []
...
if __name__ == '__main__':
    ...
    # SHIDC-B-Ki-67/more255/images
    # SHIDC-B-Ki-67/last1844/images
    parser.add_argument('--source', type=str, default='../PathoNet/SHIDC-B-Ki-67/last1844/images', help='source')
